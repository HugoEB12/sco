  <nav class="topnav">
    <ul class="topnav-list bg-default-theme text-default">
      ...
      <li class="topnav-item right">
        <div class="dropdown">
          <button class="dropbtn topnav-link dropdown-toggle" onclick="dropdown('dropdown1')">
            Bienvenido(a): <?php echo $_SESSION["name_user"]." ".$_SESSION["lname_user"]; ?>
            <i class="fa fa-caret-down"></i>
          </button>
          <div class="dropdown-content" id="dropdown1">
            <a href="profile.php" class="link link-outline-default img">
              Perfil
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="../../Controllers/SessionController.php?from=user&destroy=yes&csrf=<?php echo htmlspecialchars($_SESSION["token_user"]);?>" class="link link-outline-default">
