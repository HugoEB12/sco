      ...
      <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <div class="container">
            ...
            <div class="p-3 mb-2 rounded bg-gradient-purple text-white">
              Turnar a:
            </div>

            <hr class="bg-purple"/>

            <form id="form_finish" action="<?php echo formAction; ?>" method="POST">
              <!---->
              ...
              <input type="hidden" name="from" value="finish">
							<!---->
              
              <div class="form-group form-inline">
                <label class="p-2"><span class="text-danger">*</span> Respuesta Final:</label>
                <div class="input-group">
                  <div class="input-group-prepend">
                    <div class="input-group-text">
                      <img src="<?php echo Assets;?>/images/icons/mono/16x16/form/discuss-issue.png">
                    </div>
                  </div>
                  <input type="text" class="form-control" placeholder="RESPUESTA FINAL" name="final_response">
                  <label class="p-2">
                  	<i>
                  		Por ejemplo: "Positivo", "Negaivo", "Favorable", "No procede" o alguna instrucción más específica.
                  	</i>
                  </label>
                </div>
