...
<html lang="en">
  <head>
    <title>Administradores | Vista Detallada</title>
  ...
  <body onload="startTime()">
    ...
    <div class="side-content">
      ...
      <?php $administrator = $controller->showById($_GET["id"]); ?>
      <!---->
      <div class="container">
        <br>
        <h4>
          <strong>
            Vista detallada del Administrador(a):
            <i>
              <?php echo($administrator["id_admin"]); ?>
            </i>
          </strong>
        </h4>
        <hr class="bg-info">
        <div class="col-lg-12">
          ...
          <div class="container text-center">
            <h4>
              Nombre completo: <?php echo($administrator["name"]." ".$administrator["lname"]); ?>
                ...
                <table class="table table-striped table-bordered text-left align-middle">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo("...".substr($administrator["password"],40,120)."..."); ?></td>
                    </tr>
                    <tr>
