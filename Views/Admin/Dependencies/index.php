...
<html lang="en">
  <head>
    <title>Dependencias | Principal</title>
    ...
    <div class="side-content">
      ...
      <div class="container">
        ...
        <div class="col-lg-12">
          ...
          <h4 class="text-default text-center"><strong>Dependencias</strong> registradas actualmente</h4>
          <hr class="border-default-theme"/>
          <a href="new.php?page=<?php echo isset($_GET["page"])?$_GET["page"]:"";?>" class="link link-outline-success img">
            Crear Dependencia <img src="<?php echo(Assets)."/images/icons/mono/16x16/plus.png" ?>">
          </a>
          <!---->
          <?php $controller = new DependencyController(); ?>
          <?php $entity = $controller->showPaginate(isset($_GET["page"])?$_GET["page"]:0); ?>
          <?php if (count($entity) > 0){ ?>
            <hr class="border-default-theme"/>
            <div class="table-responsive">
              <table class="table table-sm table-hover table-bordered">
                <caption>Lista de Dependencias</caption>
                ...
                <tbody align="center">
                  <?php foreach ($entity as $key => $e):?>
                    <?php $id = $e["id_dependency"]; ?>
                    <tr>
                      <th class="bg-default-theme text-default"><?php echo($key); ?></th>
                      <td><?php echo($id); ?></td>
                      <td><?php echo($e["name_dependency"]); ?></td>
                      <td><?php echo($e["name_type"]); ?></td>
                      <td class="bg-light">
